...
// URLs do Cardápio (Squad 1 - Sprint 1)
const URL_API_CARDAPIO = "http://localhost:8081"; //
const URL_MOCK_CARDAPIO = "http://localhost:3081"; //

export const USE_MOCKS = true; // Alterna a chave para todo o projeto[cite: 2]
...
export const CONFIG_API = Object.freeze({
  ...
  cardapio: Object.freeze({
    baseUrl: USE_MOCKS ? URL_MOCK_CARDAPIO : URL_API_CARDAPIO, //[cite: 2]
  }),
});